...
module print_leroiair_vars

contains

  SUBROUTINE PRINT_FORJAC_VARS (NDATA,INRM,DNORM,XDATA,XMODL,XWTS,NPAR,XPAR,CXPAR,SUMSQ,JCBN,A,VERR,TDFD, &
    ...
    INTEGER NDATA,INRM
    REAL DNORM(NDATA),XDATA(NDATA),XMODL(NDATA)
    INTEGER XWTS(NDATA)
    INTEGER NPAR
    REAL XPAR(NPAR),SUMSQ(2)
    INTEGER CXPAR(NPAR)
    LOGICAL JCBN
    REAL A(NDATA,NPAR+1),VERR(NDATA)
    INTEGER TDFD,CMP,STEP,IDER,NSX
    REAL SWX(NSX),SWY(NSX,3)
    INTEGER NTYRP
    REAL TRP(NTYRP)
    INTEGER NPULS
    REAL PULSE
    INTEGER NTYPLS,MCHNL,NCHNL
    REAL TOPN(NCHNL),TCLS(NCHNL)
    INTEGER GSTRP,ASTRP,NFRQ
    REAL FREQ(NFRQ)
    INTEGER KNRM
    REAL NORM(KNRM)
    ...
    LOGICAL TXA90
    INTEGER NRX
    REAL TXCLN(NRXST),XRX(NRXST),YRX(NRXST),ZRX(NRXST)
    INTEGER NSTAT
    REAL SX(NSTAT),SY(NSTAT),SZ(NSTAT),FANGLE(NSTAT)
    LOGICAL SAME_TX(NSTAT)
    REAL RX(NSTAT,NRX),RY(NSTAT,NRX),RZ(NSTAT,NRX)
    INTEGER NLYR
    REAL RMU(NLYR),REPS(NLYR),CALF(NLYR),CTAU(NLYR),CFREQ(NLYR)
    REAL XYNORM,PARFAC
    INTEGER NPLT
    ...
    INTEGER I
    write(101,*) '============================='
    WRITE(101,*) 'NDATA',NDATA
    WRITE(101,*) 'INRM',INRM
    WRITE(101,*) 'DNORM',DNORM
    WRITE(101,*) 'XDATA',XDATA
    WRITE(101,*) 'XMODL',XMODL
    WRITE(101,*) 'XWTS',XWTS
    WRITE(101,*) 'NPAR',NPAR
    WRITE(101,*) 'XPAR',XPAR
    WRITE(101,*) 'CXPAR',CXPAR
    WRITE(101,*) 'SUMSQ',SUMSQ
    WRITE(101,*) 'JCBN',JCBN
    WRITE(101,*) 'A'
    DO I=1,NDATA
       WRITE(101,*) I,A(I,:)
    ...
    WRITE(101,*) 'NTYRP',NTYRP
    WRITE(101,*) 'TRP',TRP
    WRITE(101,*) 'NPULS',NPULS
    WRITE(101,*) 'PULSE',PULSE
    WRITE(101,*) 'NTYPLS',NTYPLS
    WRITE(101,*) 'MCHNL',MCHNL
    WRITE(101,*) 'NCHNL',NCHNL
    WRITE(101,*) 'TOPN',TOPN
    WRITE(101,*) 'TCLS',TCLS
    WRITE(101,*) 'GSTRP',GSTRP
    WRITE(101,*) 'ASTRP',ASTRP
    WRITE(101,*) 'NFRQ',NFRQ
    WRITE(101,*) 'FREQ',FREQ
    WRITE(101,*) 'KNRM',KNRM
    WRITE(101,*) 'NORM',NORM
    WRITE(101,*) 'TXCLN',TXCLN
    WRITE(101,*) 'TXA90',TXA90
    WRITE(101,*) 'NRX',NRX
    WRITE(101,*) 'XRX',XRX
    WRITE(101,*) 'YRX',YRX
    WRITE(101,*) 'ZRX',ZRX
    WRITE(101,*) 'NRXST',NRXST
    WRITE(101,*) 'NSTAT', NSTAT
    WRITE(101,*) 'SX',SX
    WRITE(101,*) 'SY',SY
    WRITE(101,*) 'SZ',SZ
    WRITE(101,*) 'FANGLE',FANGLE
    write(101,*) 'SAME_TX',SAME_TX
    write(101,*) 'RX'
    DO I=1,NSTAT
       write(101,*) i,RX(i,:)
    END DO
    ...
    WRITE(101,*) 'CALF', CALF
    WRITE(101,*) 'CTAU',CTAU
    WRITE(101,*) 'CFREQ',CFREQ
    WRITE(101,*) 'XYNORM',XYNORM
    WRITE(101,*) 'PAFAC',PARFAC
    WRITE(101,*) 'NPLT',NPLT
    WRITE(101,*) 'CELLW',CELLW
    WRITE(101,*) 'MXAB',MXAB
    WRITE(101,*) 'MXB',MXB
    WRITE(101,*) 'CALFP',CALFP
    WRITE(101,*) 'CTAUP', CTAUP
    WRITE(101,*) 'CFREQP', CFREQP
    WRITE(101,*) 'NW',NW

  END SUBROUTINE PRINT_FORJAC_VARS


  SUBROUTINE PRINT_FORJAC2_VARS (nlyr,res,thk,NPLT,pres,plngth,pwdth,pthk,peast,pnorth,ptop,pdzm,pdip,plng, &
       NDATA,XMODL,PARFAC,JCBN,A, &
       TDFD, CMP,STEP,IDER,NSX,SWX,SWY,NTYRP,TRP,NPULS,PULSE,NTYPLS, &
       NCHNL,TOPN, TCLS,GSTRP,ASTRP,NFRQ,FREQ,KNRM,NORM,TXA90, &
       NSTAT,xrx,yrx,zrx,sx,sy,sz,txcln,tazi,SAME_TX,RX,RY,RZ, &
       RMU,REPS,CALF,CTAU,CFREQ,CALFP,CTAUP,CFREQP, &
       CELLW,MXAB,MXB)
    ...
    Integer nlyr
    real res(nlyr),thk(nlyr-1)
    integer NPLT
    real pres(nplt),plngth(nplt),pwdth(nplt),pthk(nplt),peast(nplt),pnorth(nplt),ptop(nplt),pdzm(nplt),pdip(nplt),plng(nplt)
    integer ndata
    real xmodl(ndata)
    real parfac
    logical JCBN
    ...
    LOGICAL TXA90
    real XRX(NSTAT),YRX(NSTAT),ZRX(NSTAT)
    real SX(NSTAT),SY(NSTAT),SZ(NSTAT)
    real TXCLN(NSTAT),TAZI(NSTAT)
    Logical SAME_TX(NSTAT)
    real RX(NSTAT),RY(NSTAT),RZ(NSTAT)
    REAL RMU(NLYR),REPS(NLYR),CALF(NLYR),CTAU(NLYR),CFREQ(NLYR)
    REAL CALFP(NPLT),CTAUP(NPLT),CFREQP(NPLT)
    REAL CELLW
    INTEGER MXAB,MXB
    ...
    WRITE(101,*) 'NPLT',NPLT
    WRITE(101,*) 'PRES',PRES
    WRITE(101,*) 'PLNGTH',PLNGTH
    WRITE(101,*) 'PWDTH',PWDTH
    WRITE(101,*) 'PTHK',PTHK
    WRITE(101,*) 'PEAST',PEAST
    WRITE(101,*) 'PNORTH',PNORTH
    WRITE(101,*) 'PTOP',PTOP
    WRITE(101,*) 'PDZM',PDZM
    WRITE(101,*) 'PDIP',PDIP
    WRITE(101,*) 'PLNG',PLNG
    ...
    WRITE(101,*) 'CFREQ',CFREQ
    WRITE(101,*) 'CELLW',CELLW
    WRITE(101,*) 'CALF', CALFP
    WRITE(101,*) 'CTAU',CTAUP
    WRITE(101,*) 'CFREQ',CFREQP
    WRITE(101,*) 'MXAB',MXAB
    WRITE(101,*) 'MXB',MXB
  END SUBROUTINE PRINT_FORJAC2_VARS


  SUBROUTINE PRINT_FORJAC22_VARS (nlyr,res,thk,NPLT,pres,plngth,pwdth,pthk,peast,pnorth,ptop,pdzm,pdip,plng, &
       NDATA,XMODL,PARFAC,JCBN,A, &
       TDFD, CMP,STEP,IDER,NSX,SWX,SWY,NTYRP,TRP,NPULS,PULSE,NTYPLS, &
       NCHNL,TOPN, TCLS,GSTRP,ASTRP,NFRQ,FREQ,KNRM,NORM,TXA90, &
       NSTAT,xrx,yrx,zrx,sx,sy,sz,txcln,tazi,SAME_TX,RX,RY,RZ, &
    ...
    REAL, DIMENSION(NLYR*NSTAT) :: RES
    REAL, DIMENSION((NLYR-1)*NSTAT) :: THK
    ...
    WRITE(101,*) 'MXAB',MXAB
    WRITE(101,*) 'MXB',MXB
  END SUBROUTINE PRINT_FORJAC22_VARS


  SUBROUTINE PRINT_LEROI_3D_VARS (TDFD,NFRQ,FREQ,NLYR,THK,RES,RMU,REPS,CALF,CTAU,CFREQ,NPLT,MXAB,  &
       MXB,NB,NA,DA,DB,XCELL,YCELL,ZCELL,PLTOP,PLWDTH,PLNGTH,XCNTR,YCNTR, &
       PLAZM,PLDIP,SIG_T,CALFP,CTAUP,CFREQP,NSTAT,FANGLE,SX,SY,SZ,TXCLN,  &
       TXA90,SAME_TX,NRX,NRXST,RX,RY,RZ,BFD_SCAT,leroiair_failure_count)
    !-----------------------------------------------------------------------------------
    ...
    INTEGER, PARAMETER :: NCPTS=3     !  Number of points for MGT gaussian integration
    COMPLEX, PARAMETER :: ZERO=(0.,0.)
    INTEGER NW,TDFD,NFRQ,NLYR,NPLT,MXAB,MXB,NSTAT,NRX,NA(NPLT),NB(NPLT),NRXST
    REAL FREQ(NFRQ),THK(NLYR),XCELL(MXAB,NPLT),YCELL(MXAB,NPLT),ZCELL(MXB,NPLT), &
         XRM(NSTAT,NRX,NPLT),YRM(NSTAT,NRX,NPLT),TXCLN(NRXST)
    REAL, DIMENSION(NLYR) :: RES,RMU,REPS,CALF,CTAU,CFREQ
    REAL, DIMENSION(NPLT) :: SIG_T,CALFP,CTAUP,CFREQP,PLTOP,PLWDTH,XCNTR,YCNTR, &
         PLNGTH,PLAZM,PLDIP,DA,DB
    REAL, DIMENSION(NSTAT) :: SX,SY,SZ,FANGLE
    REAL, DIMENSION(NSTAT,NRX) :: RX,RY,RZ
    ...
    WRITE(102,*) 'DA',DA
    WRITE(102,*) 'DB',DB
    WRITE(102,*) 'XCELL',XCELL
    WRITE(102,*) 'YCELL',YCELL
    WRITE(102,*) 'ZCELL',ZCELL
    ...
    WRITE(102,*) 'CALFP',CALFP
    WRITE(102,*) 'CTAUP',CTAUP
    WRITE(102,*) 'CFREQP',CFREQP
    WRITE(102,*) 'NSTAT',NSTAT
    WRITE(102,*) 'FANGLE',FANGLE
    WRITE(102,*) 'SX',SX
    WRITE(102,*) 'SY',SY
    WRITE(102,*) 'SZ',SZ
    WRITE(102,*) 'TXCLN',TXCLN
    WRITE(102,*) 'TXA90',TXA90
    WRITE(102,*) 'SAME_TX',SAME_TX
    WRITE(102,*) 'NRX',NRX
    WRITE(102,*) 'NRXST',NRXST
    WRITE(102,*) 'RX',RX
    WRITE(102,*) 'RY',RY
    WRITE(102,*) 'RZ',RZ
    ...
    do  j=1,NSTAT
       WRITE(102,*) 'NSTAT J',j
       do i=1,NFRQ
          write(102,*) BFD_SCAT(i,j,:)
       end do
    end do



  END SUBROUTINE PRINT_LEROI_3D_VARS





  SUBROUTINE PRINT_TDEM_3D_VARS (STEP,IDER,NSX,SWX,SWY,NPULS,PULSE,NTYPLS,NTYRP,TRP,NCHNL, &
       TOPN,TCLS,FREQ,NFRQ,NSTAT,BFD_SCAT,GSTRP,ASTRP,BTD_SCAT)
    !----------------------------------------------------------------------------
    ...
    REAL PULSE,FREQ(NFRQ),T0_MIN,SWX(NSX),SWY(NSX,3),&
         TOPN(NCHNL),TCLS(NCHNL),TRP(NTYRP),BTD_SCAT(NCHNL,NSTAT)
    COMPLEX BFD_SCAT(NFRQ,NSTAT,3)
    ...
    WRITE(103,*) 'SWX',SWX
    WRITE(103,*) 'SWY',SWY
    WRITE(103,*) 'NPULS',NPULS
    WRITE(103,*) 'PULSE',PULSE
    WRITE(103,*) 'NTYPLS',NTYPLS
    WRITE(103,*) 'NTYRP',NTYRP
    WRITE(103,*) 'TRP',TRP
    WRITE(103,*) 'NCHNL',NCHNL
    WRITE(103,*) 'TOPN',TOPN
    WRITE(103,*) 'TCLS',TCLS
    WRITE(103,*) 'FREQ',FREQ
    WRITE(103,*) 'NFRQ',NFRQ
    WRITE(103,*) 'NSTAT',NSTAT
    WRITE(103,*) 'BFD_SCAT',BFD_SCAT
    WRITE(103,*) 'GSTR',GSTRP
    WRITE(103,*) 'ASTRP',ASTRP
    WRITE(103,*) 'BTD_SCAT',BTD_SCAT
  end subroutine print_tdem_3d_vars


  SUBROUTINE PRINT_HSBOSS_TD_VARS (STEP,IDER,NSX,SWX,SWY,NPULS,PULSE,NTYPLS,NTYRP,TRP,NCHNL,TOPN, &
       TCLS,TXCLN,NSTAT,SZ,ZRX,XRX,YRX,NLYR,RES,REPS,RMU,THK, &
       CALF,CTAU,CFREQ,GSTRP,ASTRP,BTD)
    !------------------------------------------------------------------------------------
    ...
    INTEGER, PARAMETER :: NFRQ=NF_6PDE, NRXF=1, QL=SELECTED_REAL_KIND(12,80)
    REAL, PARAMETER :: TWOPI=6.283185307
    INTEGER STEP,IDER,NSX,NPULS,NTYPLS,NTYRP,NCHNL,NSTAT,NLYR,GSTRP,ASTRP
    REAL SWX(NSX),SWY(NSX,3),PULSE,TRP(NTYRP),SZ(NSTAT),BTD(NCHNL,NSTAT,3)
    REAL, DIMENSION(NCHNL) :: TOPN,TCLS
    REAL, DIMENSION(NLYR) :: RES,REPS,THK,CTAU,CFREQ,CALF,RMU
    REAL, DIMENSION(NSTAT) :: TXCLN,ZRX,XRX,YRX
    LOGICAL SAME_TX(NSTAT)
    ...
    WRITE(104,*) 'SWX',SWX
    WRITE(104,*) 'SWY',SWY
    WRITE(104,*) 'NPULS',NPULS
    WRITE(104,*) 'PULSE',PULSE
    WRITE(104,*) 'NTYPLS',NTYPLS
    WRITE(104,*) 'NTYRP',NTYRP
    WRITE(104,*) 'TRP',TRP
    WRITE(104,*) 'NCHNL',NCHNL
    WRITE(104,*) 'TOPN',TOPN
    WRITE(104,*) 'TCLS',TCLS
    WRITE(104,*) 'TXCLN',TXCLN
    WRITE(104,*) 'NSTAT',NSTAT
    WRITE(104,*) 'SAME_TX',SAME_TX
    WRITE(104,*) 'SZ',SZ
    WRITE(104,*) 'ZRX',ZRX
    WRITE(104,*) 'XRX',XRX
    WRITE(104,*) 'YRX',YRX
    ...
    WRITE(104,*) 'CALF',CALF
    WRITE(104,*) 'CTAU',CTAU
    WRITE(104,*) 'CFREQ',CFREQ
    WRITE(104,*) 'GSTRP',GSTRP
    WRITE(104,*) 'ASTRP',ASTRP
    WRITE(104,*) 'BTD',BTD



  end subroutine PRINT_HSBOSS_TD_VARS


  SUBROUTINE PRINT_SET_CELLS_VARS (KP,NPLT,NLYR,MXAB,MXB,CELLW,THK,PLNGTH,PLWDTH,NA,NB,DA,DB, &
    ...
    INTEGER NPLT,NLYR,MXAB,MXB,NA(NPLT),NB(NPLT),KP
    REAL THK(NLYR),CELLW,XCELL(MXAB,NPLT),YCELL(MXAB,NPLT),ZCELL(MXB,NPLT),PCNR(3,4,NPLT)
    ...
    WRITE(105,*) 'MXAB',MXAB
    WRITE(105,*) 'MXB',MXB
    WRITE(105,*) 'CELLW',CELLW
    WRITE(105,*) 'THK',THK
    WRITE(105,*) 'PLNGTH',PLNGTH
    WRITE(105,*) 'PLWDTH',PLWDTH
    WRITE(105,*) 'NA',NA
    WRITE(105,*) 'NB',NB
    WRITE(105,*) 'DA',DA
    WRITE(105,*) 'DB',DB
    WRITE(105,*) 'XCNTR',XCNTR
    WRITE(105,*) 'YCNTR',YCNTR
    WRITE(105,*) 'PLTOP',PLTOP
    WRITE(105,*) 'PLAZM',PLAZM
    WRITE(105,*) 'PLDIP',PLDIP
    WRITE(105,*) 'PLUNJ',PLUNJ
    WRITE(105,*) 'XCELL',XCELL
    WRITE(105,*) 'YCELL',YCELL
    WRITE(105,*) 'ZCELL',ZCELL
    WRITE(105,*) 'PCNR',PCNR
  END SUBROUTINE PRINT_SET_CELLS_VARS


  SUBROUTINE PRINT_SET_SOURCE_VARS (STEP,ISW,BFFAC,WAVEFORM,NSX,SWX,SWY,PRM_TD)
    !------------------------------------------------------------------
    ...
    IMPLICIT NONE
    INTEGER ISW,STEP,NSX
    REAL BFFAC,SWX(NSX),WAVEFORM(NSX),SWY(NSX,3),PRM_TD(3)
    WRITE(106,*) '============================='

    WRITE(106,*) 'STEP',STEP
    WRITE(106,*) 'ISW',ISW
    WRITE(106,*) 'BFFAC',BFFAC
    WRITE(106,*) 'WAVEFORM',WAVEFORM
    WRITE(106,*) 'NSX',NSX
    WRITE(106,*) 'SWX',SWX
    WRITE(106,*) 'SWY',SWY
    WRITE(106,*) 'PRM_TD',PRM_TD


  END SUBROUTINE PRINT_SET_SOURCE_VARS


  SUBROUTINE PRINT_DCPRM_TD_VARS(XRX0,YRX0,ZRX0,TXCLN0,TXAREA,PRM_TD)
    ...
    IMPLICIT NONE
    REAL TXAREA,TXCLN0,XRX0,YRX0,ZRX0,PRM_TD(3)
    WRITE(107,*) '============================='

    WRITE(107,*) 'XRX0',XRX0
    WRITE(107,*) 'YRX0',YRX0
    WRITE(107,*) 'ZRX0',ZRX0
    WRITE(107,*) 'TXCLN0',TXCLN0

    WRITE(107,*) 'TXAREA',TXAREA
    WRITE(107,*) 'PRM_TD',PRM_TD

  END  SUBROUTINE PRINT_DCPRM_TD_VARS


  SUBROUTINE PRINT_SET_NORM_TD_VARS (BUNIT,BFFAC,KPPM,PUNIT,PPFAC,PRM_TD,NORM)
    !--------------------------------------------------------------------
    ...
    IMPLICIT NONE
    INTEGER KPPM
    REAL PRM_TD(3),NORM(3),PPFAC,BFFAC
    CHARACTER (LEN=4) BUNIT,PUNIT
    WRITE(108,*) '============================='

    WRITE(108,*) 'BUNIT',BUNIT
    WRITE(108,*) 'BFFAC',BFFAC
    WRITE(108,*) 'KPPM',KPPM
    WRITE(108,*) 'PUNIT',PUNIT
    WRITE(108,*) 'PPFAC',PPFAC
    WRITE(108,*) 'PRM_TD',PRM_TD
    WRITE(108,*) 'NORM',NORM

  END SUBROUTINE PRINT_SET_NORM_TD_VARS



end module print_leroiair_vars
